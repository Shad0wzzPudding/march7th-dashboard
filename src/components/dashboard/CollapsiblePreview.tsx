...
export function CollapsiblePreview<T>({ items, previewCount, renderList, label = 'items' }: Props<T>) {
  ...
  return (
    <div className="relative">
      ...
      <div className="pink-shimmer pointer-events-none absolute inset-x-0 bottom-0 h-32 flex items-end justify-center rounded-b-2xl bg-gradient-to-t from-primary/50 via-primary/20 to-transparent backdrop-blur-md [box-shadow:inset_0_-10px_30px_-10px_hsl(var(--primary)/0.3)]">
        <button
          type="button"
